...
public class DateEx1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(now.getTime());	//1900년부터
		
		System.out.println(now.getYear()+1900);//년, 기준 1900
		System.out.println(now.getMonth()+1); //월, 출력 달 + 1
		...
		String dTime = format.format(currentTime); //format을 하면 문자열로 적용되기 때문에 문자열 변수에 넣어야 한다
		System.out.println("(년.월.일.시.분.초) : "+dTime);
		
		String dTime2 = format2.format(currentTime); //format을 하면 문자열로 적용되기 때문에 문자열 변수에 넣어야 한다
